...
route.get(
  "/addOfferImages",
  Authenticate.isAdmin,
  adminController.addOfferImages
);

route.post(
  "/addOfferImages",
  Authenticate.isAdmin,
  adminController.postAddOfferImages
);

route.get(
  "/getOfferImages",
  Authenticate.isAdmin,
  adminController.getOfferImages
);

route.get(
  "/editOfferImage",
  Authenticate.isAdmin,
  adminController.editOfferImage
);

route.post(
  "/editOfferImage",
  Authenticate.isAdmin,
  adminController.postEditOfferImage
);

route.post(
  "/deleteOfferImage",
  Authenticate.isAdmin,
  adminController.postDeleteOfferImage
);
...
route.post(
  ...
  function (req, res) {
    req.session.isAdmin = req.user._id;
    res.redirect("/");
  }
);
